...
export class UtilityService {
  ...
  convertKeysToCamelCase = (obj: any[] | any): any[] | any => {
    if (this.isObject(obj)) {
      ...
      Object.keys(obj).forEach((key) => {
        newObj[this.convertToCamelCase(key)] = this.convertKeysToCamelCase(
          obj[key],
        );
      });
  ...
  convertKeysToSnakeCase = (obj: any[] | any): any[] | any => {
    if (this.isObject(obj)) {
      ...
      Object.keys(obj).forEach((key) => {
        newObj[this.convertToSnakeCase(key)] = this.convertKeysToSnakeCase(
          obj[key],
        );
      });
  ...
  static formatDate = (inputDate: string): string => {
    try {
      UtilityService.isValidDate(inputDate);
